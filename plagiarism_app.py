...
# =============================================================================
# CRITICAL FIX: Setup Function for NLTK Data
# This section must run immediately after imports and before any other code.
# =============================================================================
def setup_nltk():
    """
    ...
    try:
        ...
        # Using st.info might not be visible during initial setup on cloud,
        # but it's good practice. The download will happen regardless.
        nltk.download('punkt')
    try:
...
# =============================================================================
# Class Definitions
# Now that NLTK data is guaranteed to be present, these classes can be defined.
# =============================================================================
...
def get_detector():
    ...
    detector.load_reference_texts()
    return detector, len(detector.reference_texts)
